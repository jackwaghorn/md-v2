 ...
 */
type TitleField<State extends FieldState = FieldState> = State extends "empty" ? [] : [
 ...
 */
type ImageField<ThumbnailNames extends string | null = never, State extends FieldState = FieldState> = Simplify<ImageFieldImage<State> & Record<Exclude<Extract<ThumbnailNames, string>, keyof ImageFieldImage>, ImageFieldImage<State>>>;
 ...
 */
type GroupField<Fields extends Record<string, AnyRegularField> = Record<string, AnyRegularField>, State extends FieldState = FieldState> = State extends "empty" ? [] : [Fields, ...Fields[]];
 ...
 */
type SharedSlice<SliceType = string, Variations extends SharedSliceVariation = SharedSliceVariation> = {
 ...
 * @typeParam State - State of the field which determines its shape.
 */
type LinkToMediaField<State extends FieldState = FieldState> = State extends "empty" ? EmptyLinkField<typeof LinkType.Media> : FilledLinkToMediaField;
/**
 ...
 */
type EmptyLinkField<Type extends typeof LinkType[keyof typeof LinkType] = typeof LinkType.Any> = {
 ...
 * @typeParam State - State of the field which determines its shape.
 */
type ContentRelationshipField<TypeEnum = string, LangEnum = string, DataInterface extends Record<string, AnyRegularField | GroupField | SliceZone> | unknown = unknown, State extends FieldState = FieldState> = State extends "empty" ? EmptyLinkField<typeof LinkType.Document> : FilledContentRelationshipField<TypeEnum, LangEnum, DataInterface>;
/**
 ...
 */
type DateField<State extends FieldState = FieldState> = State extends "empty" ? null : `${number}-${number}-${number}`;
 ...
 * @typeParam State - State of the field which determines its shape.
 */
type TimestampField<State extends FieldState = FieldState> = State extends "empty" ? null : `${DateField<"filled">}T${number}:${number}:${number}+${number}`;
 ...
 */
type IntegrationFields<Data extends Record<string, unknown> = Record<string, unknown>, State extends FieldState = FieldState> = State extends "empty" ? null : Data;
 ...
 */
type AnyRegularField = TitleField | RichTextField | ImageField | ContentRelationshipField | LinkField | LinkToMediaField | EmbedField | DateField | TimestampField | ColorField | NumberField | KeyTextField | SelectField | BooleanField | GeoPointField | IntegrationFields;
/**
 ...
 * More details: {@link https://prismic.io/docs/core-concepts/rich-text-title}
 */
type CustomTypeModelTitleField = CustomTypeModelRichTextSingleField;
 ...
 */
type CustomTypeModelLegacySlice = CustomTypeModelGroupField | CustomTypeModelFieldForGroup;
