 ...
 */
type RelationField<ExtendedLinkToDocumentField extends FilledMinimalLinkToWebField = FilledMinimalLinkToWebField, IsEmpty extends boolean = boolean> = IsEmpty extends true ? EmptyLinkField : ExtendedLinkToDocumentField;
/**
 * Link Field
 */
type LinkField<ExtendedLinkToDocumentField extends FilledMinimalLinkToDocumentField = FilledMinimalLinkToDocumentField, ExtendedLinkToWebField extends FilledMinimalLinkToWebField = FilledMinimalLinkToWebField, ExtendedLinkToMediaField extends FilledMinimalLinkToMediaField = FilledMinimalLinkToMediaField, IsEmpty extends boolean = boolean> = IsEmpty extends true ? EmptyLinkField : ExtendedLinkToDocumentField | ExtendedLinkToWebField | ExtendedLinkToMediaField;
/**
 * Link field that points to media
 */
type LinkToMediaField<ExtendedLinkToMediaField extends FilledMinimalLinkToMediaField = FilledMinimalLinkToMediaField, IsEmpty extends boolean = boolean> = IsEmpty extends true ? EmptyLinkField : ExtendedLinkToMediaField;
