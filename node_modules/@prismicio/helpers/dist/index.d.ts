...
import { DateField, TimestampField, FilledLinkToDocumentField, PrismicDocument, FilledLinkToWebField, FilledLinkToMediaField, LinkField, RichTextField, ImageFieldImage, TitleField, LinkToMediaField, ColorField, NumberField, KeyTextField, AnyOEmbed, GeoPointField, AnyRegularField, Slice, SharedSlice } from '@prismicio/types';
 ...
 */
type LinkResolverFunction<ReturnType = string> = (linkToDocumentField: FilledLinkToDocumentField) => ReturnType;
/**
 ...
 */
type HTMLMapSerializerFunction<BlockType extends keyof RichTextMapSerializer<string>> = RichTextMapSerializerFunction<string, ExtractNodeGeneric<RichTextMapSerializer<string>[BlockType]>, ExtractTextTypeGeneric<RichTextMapSerializer<string>[BlockType]>>;
/**
 ...
 */
declare const asLink: <LinkResolverFunctionReturnType = string, Field extends PrismicDocument<Record<string, any>, string, string> | FilledLinkToDocumentField<string, string, unknown> | _prismicio_types.EmptyLinkField<"Any"> | FilledLinkToWebField | FilledLinkToMediaField | null | undefined = PrismicDocument<Record<string, any>, string, string> | FilledLinkToDocumentField<string, string, unknown> | _prismicio_types.EmptyLinkField<"Any"> | FilledLinkToWebField | FilledLinkToMediaField | null | undefined>(linkFieldOrDocument: Field, linkResolver?: LinkResolverFunction<LinkResolverFunctionReturnType> | null | undefined) => AsLinkReturnType<LinkResolverFunctionReturnType, Field>;
 ...
 * @returns `true` if `field` is filled, `false` otherwise.
 */
declare const link: <TypeEnum, LangEnum, DataInterface extends unknown>(field: _prismicio_types.EmptyLinkField<"Any"> | _prismicio_types.FilledLinkToWebField | _prismicio_types.FilledLinkToMediaField | _prismicio_types.FilledContentRelationshipField<TypeEnum, LangEnum, DataInterface> | null | undefined) => field is _prismicio_types.FilledLinkToWebField | _prismicio_types.FilledLinkToMediaField | _prismicio_types.FilledContentRelationshipField<TypeEnum, LangEnum, DataInterface>;
/**
