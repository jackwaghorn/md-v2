...
const rt = "random", Z = /* @__PURE__ */ new Map();
function De(n) {
  Z.set(n.key, n);
}
function ee(n, e, t) {
...
function ft(n) {
  var e, t, i, s, o, r;
  const { container: l, context: a, particle: h, delta: d, colorStyles: c, backgroundMask: f, composite: p, radius: u, opacity: v, shadow: m, transform: b } = n, x = h.getPosition(), R = h.rotation + (h.pathRotation ? h.velocity.angle : 0), M = {
    sin: Math.sin(R),
    cos: Math.cos(R)
  }, T = {
  ...
  a.setTransform(T.a, T.b, T.c, T.d, x.x, x.y), a.beginPath(), f && (a.globalCompositeOperation = p);
  const C = h.shadowColor;
  m.enable && C && (a.shadowBlur = m.blur, a.shadowColor = J(C), a.shadowOffsetX = m.offset.x, a.shadowOffsetY = m.offset.y), c.fill && (a.fillStyle = c.fill);
  const S = h.stroke;
  a.lineWidth = (o = h.strokeWidth) !== null && o !== void 0 ? o : 0, c.stroke && (a.strokeStyle = c.stroke), pt(l, a, h, u, v, d), ((r = S == null ? void 0 : S.width) !== null && r !== void 0 ? r : 0) > 0 && a.stroke(), h.close && a.closePath(), h.fill && a.fill(), mt(l, a, h, u, v, d), a.globalCompositeOperation = "source-over", a.setTransform(1, 0, 0, 1, 0, 0);
}
...
const G = "generated", ze = "touchend", _t = "pointerdown", bt = "pointerup", Me = "pointermove", wt = "touchstart", xt = "touchmove", Pe = "pointerleave", zt = "pointerout", Mt = "touchcancel", Pt = "resize", Ot = "visibilitychange";
function kt(n, e, t) {
  var i;
  const s = e[t];
...
class Ct {
  constructor(e) {
    this.container = e, this.size = {
      height: 0,
      width: 0
    }, this._context = null, this._generated = !1, this._preDrawUpdaters = [], this._postDrawUpdaters = [], this._resizePlugins = [], this._colorPlugins = [], this._mutationObserver = !X() && typeof MutationObserver < "u" ? new MutationObserver((t) => {
      for (const i of t)
  ...
  drawParticle(e, t) {
    ...
    l || (l = o), a || (a = r), !(!l && !a) && this.draw((h) => {
      var d, c, f, p, u;
      const v = this.container.actualOptions, m = e.options.zIndex, b = (1 - e.zIndexFactor) ** m.opacityRate, x = (f = (d = e.bubble.opacity) !== null && d !== void 0 ? d : (c = e.opacity) === null || c === void 0 ? void 0 : c.value) !== null && f !== void 0 ? f : 1, R = (u = (p = e.stroke) === null || p === void 0 ? void 0 : p.opacity) !== null && u !== void 0 ? u : x, M = x * b, T = R * b, C = {}, S = {
...
class St {
  ...
  doMouseTouchClick(e) {
    ...
    if (this.canPush) {
      ...
      W(r.mode, (l) => this.handleClickMode(l));
    }
  ...
  handleThemeChange(e) {
    const t = e, i = this.container, s = i.options, o = s.defaultThemes, r = t.matches ? o.dark : o.light, l = s.themes.find((a) => a.name === r);
    l && l.default.auto && i.loadTheme(r);
  }
  ...
  manageListeners(e) {
    ...
    let l = Pe;
    if (r === "window")
      s.interactivity.element = window, l = zt;
    else if (r === "parent" && s.canvas.element) {
      const c = s.canvas.element;
      s.interactivity.element = (t = c.parentElement) !== null && t !== void 0 ? t : c.parentNode;
    } else
      s.interactivity.element = s.canvas.element;
    const a = Ee("(prefers-color-scheme: dark)");
    a && (a.addEventListener !== void 0 ? O(a, "change", i.themeChange, e) : a.addListener !== void 0 && (e ? a.addListener(i.oldThemeChange) : a.removeListener(i.oldThemeChange)));
    const h = s.interactivity.element;
    if (!h)
      return;
    const d = h;
    (o.interactivity.events.onHover.enable || o.interactivity.events.onClick.enable) && (O(h, Me, i.mouseMove, e), O(h, wt, i.touchStart, e), O(h, xt, i.touchMove, e), o.interactivity.events.onClick.enable ? (O(h, ze, i.touchEndClick, e), O(h, bt, i.mouseUp, e), O(h, _t, i.mouseDown, e)) : O(h, ze, i.touchEnd, e), O(h, l, i.mouseLeave, e), O(h, Mt, i.touchCancel, e)), s.canvas.element && (s.canvas.element.style.pointerEvents = d === s.canvas.element ? "initial" : "none"), o.interactivity.events.resize && (typeof ResizeObserver < "u" ? this.resizeObserver && !e ? (s.canvas.element && this.resizeObserver.unobserve(s.canvas.element), this.resizeObserver.disconnect(), delete this.resizeObserver) : !this.resizeObserver && e && s.canvas.element && (this.resizeObserver = new ResizeObserver((c) => {
      !c.find((p) => p.target === s.canvas.element) || this.handleWindowResize();
    }), this.resizeObserver.observe(s.canvas.element)) : O(window, Pt, i.resize, e)), document && O(document, Ot, i.visibilityChange, e, !1);
  }
  mouseDown() {
  ...
  mouseTouchFinish() {
    ...
    if (!e)
      return;
    const t = e.mouse;
    delete t.position, delete t.clickPosition, delete t.downPosition, e.status = Pe, t.inside = !1, t.clicking = !1;
  }
  mouseTouchMove(e) {
    var t, i, s, o, r, l, a;
    ...
    if (e.type.startsWith("pointer")) {
      ...
      if (h.interactivity.element === window) {
        ...
        const v = u.target, m = u.currentTarget, b = h.canvas.element;
        if (v && m && b) {
          const x = v.getBoundingClientRect(), R = m.getBoundingClientRect(), M = b.getBoundingClientRect();
          c = {
            x: u.offsetX + 2 * x.left - (R.left + M.left),
            y: u.offsetY + 2 * x.top - (R.top + M.top)
          };
        } else
          c = {
            x: (i = u.offsetX) !== null && i !== void 0 ? i : u.clientX,
            y: (s = u.offsetY) !== null && s !== void 0 ? s : u.clientY
          };
      } else
        u.target === h.canvas.element && (c = {
          x: (o = u.offsetX) !== null && o !== void 0 ? o : u.clientX,
          y: (r = u.offsetY) !== null && r !== void 0 ? r : u.clientY
        });
    } else {
      this.canPush = e.type !== "touchmove";
      const u = e, v = u.touches[u.touches.length - 1], m = f == null ? void 0 : f.getBoundingClientRect();
      c = {
        x: v.clientX - ((l = m == null ? void 0 : m.left) !== null && l !== void 0 ? l : 0),
        y: v.clientY - ((a = m == null ? void 0 : m.top) !== null && a !== void 0 ? a : 0)
      };
    }
    const p = h.retina.pixelRatio;
    c && (c.x *= p, c.y *= p), h.interactivity.mouse.position = c, h.interactivity.status = Me;
  }
}
...
class Wt {
  constructor() {
    this.onClick = new Lt(), this.onDiv = new Oe(), this.onHover = new Vt(), this.resize = new Ht();
  }
  get onclick() {
    return this.onClick;
  }
...
class Jt {
  constructor() {
    this.absorb = new Xt(), this.bounce = new Fe(), this.enable = !1, this.mode = "bounce", this.overlap = new Yt();
  }
  load(e) {
...
class ti {
  constructor() {
    this.clamp = !0, this.delay = new Y(), this.enable = !1, this.options = {};
  }
  load(e) {
...
class ii {
  constructor() {
    this.enable = !1, this.length = 10, this.fillColor = new k(), this.fillColor.value = "#000000";
  }
  load(e) {
...
const se = "character", ne = "char", oe = "image", re = "images", ae = "polygon", le = "star";
class ui {
  constructor() {
  ...
  load(e) {
    ...
    this.loadShape(e.character, se, ne, !0), this.loadShape(e.polygon, ae, le, !1), this.loadShape((s = e.image) !== null && s !== void 0 ? s : e.images, oe, re, !0), e.type !== void 0 && (this.type = e.type);
  }
  loadShape(e, t, i, s) {
    var o, r;
    if (!e)
...
class mi {
  constructor(e, t) {
    this._engine = e, this._container = t, this.bounce = new Fe(), this.collisions = new Jt(), this.color = new $(), this.color.value = "#fff", this.groups = {}, this.move = new oi(), this.number = new hi(), this.opacity = new ai(), this.reduceDuplicates = !1, this.shadow = new ci(), this.shape = new ui(), this.size = new fi(), this.stroke = new Ce(), this.zIndex = new pi();
  }
  load(e) {
    var t, i, s, o, r, l;
    if (!e)
    ...
    if (this.bounce.load(e.bounce), this.color.load($.create(this.color, e.color)), e.groups !== void 0)
      for (const d in e.groups) {
        const c = e.groups[d];
        c !== void 0 && (this.groups[d] = z((t = this.groups[d]) !== null && t !== void 0 ? t : {}, c));
      }
...
class vi {
  constructor(e, t) {
    this._engine = e, this._container = t, this.autoPlay = !0, this.background = new It(), this.backgroundMask = new Dt(), this.defaultThemes = {}, this.delay = 0, this.fullScreen = new At(), this.detectRetina = !0, this.duration = 0, this.fpsLimit = 120, this.interactivity = new Le(e, t), this.manualParticles = [], this.particles = We(this._engine, this._container), this.pauseOnBlur = !0, this.pauseOnOutsideViewport = !0, this.responsive = [], this.smooth = !1, this.style = {}, this.themes = [], this.zLayers = 100;
  }
  get backgroundMode() {
  ...
  load(e) {
    ...
    if (!e)
      return;
    e.preset !== void 0 && W(e.preset, (c) => this._importPreset(c)), e.autoPlay !== void 0 && (this.autoPlay = e.autoPlay), e.delay !== void 0 && (this.delay = g(e.delay));
    ...
    typeof h == "boolean" ? this.fullScreen.enable = h : this.fullScreen.load(h), this.backgroundMask.load(e.backgroundMask), this.interactivity.load(e.interactivity), e.manualParticles !== void 0 && (this.manualParticles = e.manualParticles.map((c) => {
      const f = new Ut();
      return f.load(c), f;
    ...
    if (d)
      for (const c of d)
        c.loadOptions && c.loadOptions(this, e);
    if (e.responsive !== void 0)
      for (const c of e.responsive) {
        const f = new qt();
        f.load(c), this.responsive.push(f);
      }
    if (this.responsive.sort((c, f) => c.maxWidth - f.maxWidth), e.themes !== void 0)
      for (const c of e.themes) {
        const f = this.themes.find((p) => p.name === c.name);
        if (f)
          f.load(c);
        else {
          const p = new Gt();
          p.load(c), this.themes.push(p);
        }
      }
...
class yi {
  ...
  init(e, t, i, s) {
    var o, r, l, a, h, d, c, f, p;
    const u = this.container, v = this._engine;
    ...
    const m = u.retina.pixelRatio, b = u.actualOptions, x = We(this._engine, u, b.particles), R = x.shape.type, { reduceDuplicates: M } = x;
    ...
    this.shapeData = this._loadShapeData(T, M), x.load(i), x.load((o = this.shapeData) === null || o === void 0 ? void 0 : o.particles), this.interactivity = new Le(v, u), this.interactivity.load(u.actualOptions.interactivity), this.interactivity.load(x.interactivity), this.fill = (l = (r = this.shapeData) === null || r === void 0 ? void 0 : r.fill) !== null && l !== void 0 ? l : this.fill, this.close = (h = (a = this.shapeData) === null || a === void 0 ? void 0 : a.close) !== null && h !== void 0 ? h : this.close, this.options = x;
    const C = this.options.move.path;
    this.pathDelay = je(C.delay) * 1e3, C.generator && (this.pathGenerator = this._engine.plugins.getPathGenerator(C.generator), this.pathGenerator && u.addPath(C.generator, this.pathGenerator) && this.pathGenerator.init(u));
    ...
    if (this.size = {
      ...
      value: y(B.value) * u.retina.pixelRatio,
      max: de(me) * m,
      min: ue(me) * m,
      loops: 0,
      maxLoops: y(B.animation.count)
    }, Q.enable)
      switch (this.size.status = "increasing", this.size.decay = 1 - y(Q.decay), Q.startValue) {
        case "min":
          this.size.value = this.size.min, this.size.status = "increasing";
          break;
        case "random":
          this.size.value = V(this.size) * m, this.size.status = D() >= 0.5 ? "increasing" : "decreasing";
          break;
        case "max":
        default:
    ...
    this.bubble = {
      ...
      inRange: !1,
      factor: 1
    }, this.position = this._calcPosition(u, t, Te(S, 0, u.zLayers)), this.initialPosition = this.position.copy();
    const ve = u.canvas.size, K = Object.assign({}, this.options.move.center), ge = K.mode === "percent";
    switch (this.moveCenter = {
      ...
      mode: (c = this.options.move.center.mode) !== null && c !== void 0 ? c : "percent"
    ...
    const j = u.particles;
    j.needsSort = j.needsSort || j.lastZIndex < this.position.z, j.lastZIndex = this.position.z, this.zIndexFactor = this.position.z / u.zLayers, this.sides = 24;
    let w = u.drawers.get(this.shape);
    w || (w = this._engine.plugins.getShapeDrawer(this.shape), w && u.drawers.set(this.shape, w)), w != null && w.loadShape && (w == null || w.loadShape(this));
    const ye = w == null ? void 0 : w.getSidesCount;
    ye && (this.sides = ye(this)), this.spawning = !1, this.shadowColor = H(this.options.shadow.color);
    for (const I of u.particles.updaters)
      I.init(this);
    for (const I of u.particles.movers)
      (f = I.init) === null || f === void 0 || f.call(I, this);
    w != null && w.particleInit && w.particleInit(u, this);
    for (const [, I] of u.plugins)
      (p = I.particleCreated) === null || p === void 0 || p.call(I, this);
  }
  isInsideCanvas() {
  ...
  _calcPosition(e, t, i, s = 0) {
    ...
    const h = e.canvas.size, d = et({
      size: h,
      position: t
    }), c = P.create(d.x, d.y, i), f = this.getRadius(), p = this.options.move.outModes, u = (m) => {
      Se({
        outMode: m,
    ...
    return u((o = p.left) !== null && o !== void 0 ? o : p.default), u((r = p.right) !== null && r !== void 0 ? r : p.default), v((l = p.top) !== null && l !== void 0 ? l : p.default), v((a = p.bottom) !== null && a !== void 0 ? a : p.default), this._checkOverlap(c, s) ? this._calcPosition(e, void 0, i, s + 1) : c;
  }
  _calculateVelocity() {
    ...
    return i.straight || (t.angle += V(g(r.left, r.right))), i.random && typeof i.speed == "number" && (t.length *= D()), t;
  }
  _checkOverlap(e, t = 0) {
...
class A {
  ...
  subdivide() {
    ...
    this._NE = new A(new E(e, t, i / 2, s / 2), o), this._NW = new A(new E(e + i / 2, t, i / 2, s / 2), o), this._SE = new A(new E(e, t + s / 2, i / 2, s / 2), o), this._SW = new A(new E(e + i / 2, t + s / 2, i / 2, s / 2), o), this._divided = !0;
  }
}
class bi {
  constructor(e, t) {
    ...
    this.quadTree = new A(new E(-i.width / 4, -i.height / 4, i.width * 3 / 2, i.height * 3 / 2), 4), this.movers = this._engine.plugins.getMovers(t, !0), this.updaters = this._engine.plugins.getUpdaters(t, !0);
  }
  get count() {
  ...
  async draw(e) {
    ...
    this.quadTree = new A(new E(-i.width / 4, -i.height / 4, i.width * 3 / 2, i.height * 3 / 2), 4), t.canvas.clear(), await this.update(e), this.needsSort && (this.zArray.sort((s, o) => o.position.z - s.position.z || s.id - o.id), this.lastZIndex = this.zArray[this.zArray.length - 1].position.z, this.needsSort = !1);
  ...
  async update(e) {
    ...
    for (const r of this.array) {
      ...
      l && !r.ignoresResizeRatio && (r.position.x *= l.width, r.position.y *= l.height, r.initialPosition.x *= l.width, r.initialPosition.y *= l.height), r.ignoresResizeRatio = !1, await this.interactionManager.reset(r);
  ...
  _applyDensity(e, t, i) {
    ...
    if (!(!((s = e.number.density) === null || s === void 0) && s.enable))
      return;
    const o = e.number, r = this._initDensityFactor(o.density), l = o.value, a = o.limit > 0 ? o.limit : l, h = Math.min(l, a) * r + t, d = Math.min(this.count, this.array.filter((c) => c.group === i).length);
...
class zi {
  ...
  addClickHandler(e) {
    ...
    const i = (c, f, p) => {
      if (!_(this))
        return;
      const u = this.retina.pixelRatio, v = {
        x: f.x * u,
        y: f.y * u
      }, m = this.particles.quadTree.queryCircle(v, p * u);
      e(c, m);
    }, s = (c) => {
      if (!_(this))
        return;
      ...
      if (!!_(this)) {
        if (h && !d) {
          ...
          if (!p && (p = f.changedTouches[f.changedTouches.length - 1], !p))
            return;
          const u = this.canvas.element, v = u ? u.getBoundingClientRect() : void 0, m = {
            x: p.clientX - (v ? v.left : 0),
            y: p.clientY - (v ? v.top : 0)
          };
          i(c, m, Math.max(p.radiusX, p.radiusY));
        }
        h = !1, d = !1;
      }
    }, a = () => {
  ...
  addPath(e, t, i = !1) {
    return !_(this) || !i && this.pathGenerators.has(e) ? !1 : (this.pathGenerators.set(e, t != null ? t : Re), !0);
  }
  destroy() {
    if (!_(this))
      return;
...
class Pi {
  ...
  async loadOptions(e) {
    ...
    const c = N(h, r), f = this._engine.dom(), p = f.findIndex((m) => m.id === o);
    if (p >= 0) {
    ...
    if (d.tagName.toLowerCase() === "canvas")
      u = d, u.dataset[G] = "false";
    else {
      const m = d.getElementsByTagName("canvas");
      m.length ? (u = m[0], u.dataset[G] = "false") : (u = document.createElement("canvas"), u.dataset[G] = "true", d.appendChild(u));
    }
    u.style.width || (u.style.width = "100%"), u.style.height || (u.style.height = "100%");
    const v = new zi(this._engine, o, c);
    return p >= 0 ? f.splice(p, 0, v) : f.push(v), v.canvas.loadCanvas(u), await v.start(), v;
  }
  ...
  async setJSON(e, t, i, s) {
    let o, r, l, a;
    return e instanceof HTMLElement ? (a = e, o = t, l = i) : (r = e, a = t, o = i, l = s), this.loadRemoteOptions({ tagId: r, url: o, index: l, element: a, remote: !0 });
  }
}
